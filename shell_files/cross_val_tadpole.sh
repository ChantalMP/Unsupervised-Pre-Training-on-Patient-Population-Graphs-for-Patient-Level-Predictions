...
# train from scratch models for all rotations and all label ratios
  ...
  for lr in 0.01 0.05 0.1 0.5 1.0; do
    ...
    --peak_lr 1e-5 --end_lr 5e-6 --edge_type multi_hop --multi_hop_max_dist 20 --check_val_every_n_epoch 1 --warmup_updates 0 --tot_updates 1200 \
    --default_root_dir "exps/tadpole_class" --log_every_n_step 1 --runname "cross_val_label_ratio${lr}" --cross_val --drop_val_patients \
    --use_sim_graph_tadpole --label_ratio ${lr} --mask_all
